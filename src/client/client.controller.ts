...
export class ClientController {
    ...
    async updateFile(@Body() body: UpdateFileDto, @Res() res: Response) {
        try {
            ...
            return res.status(HttpStatus.OK).send({ message: 'Archivo subido con éxito', url: response.url })
        } catch (error) {
            throw error
        }
    }
    ...
    async getLastVersion(@Res() res: Response) {
        try {
            ...
            return res.status(HttpStatus.OK).send({ message: 'Última versión de cliente por actualizar', client: response })
        } catch (error) {
            return res.status(error.status).send(error)
        }
    }
    ...
    async getClients(@Res() res: Response) {
        try {
            ...
            return res.status(HttpStatus.OK).send({ message: 'Última versión de cliente por actualizar', clients: response.clients })
        } catch (error) {
            return res.status(error.status).send(error)
        }
    }
    ...
    async updateClient(@Body() body: UpdateClientDto, @Res() res: Response) {
        try {
            ...
            return res.status(HttpStatus.OK).send({ message: 'Cliente actualizado', client: response })
        } catch (error) {
            return res.status(error.status).send(error)
        }
    }
